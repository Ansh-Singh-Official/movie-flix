  ...
  return (
    <div style={styles.container}>
      ...
      {selectedMovie ? (
        ...
        <>
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black text-white mb-6 tracking-tight italic leading-tight">MOVIE<span className="text-yellow-500">FLIX</span>
</h1>
