  ...
  return (
    <div style={styles.container}>
      ...
      {selectedMovie ? (
        ...
        <>
         <h1 className="text-[15vw] md:text-[12rem] font-[1000] text-white mb-6 tracking-[-0.05em] italic leading-[0.8] drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">AAGAYA MOVIE<span className="text-yellow-500 drop-shadow-[0_0_20px_rgba(234,179,8,0.5)]"> DEKHNE ?</span>
</h1>
